							...
							<div class="header-menu header-menu-resize">
								...
								<ul class="header-nav krystal-nav">
									...
									<li
										...
										<a href="#" class="dropdown-toggle">ĐIỆN THOẠI</a> <span
										class="toggle-submenu hidden-md"></span>
										<div class="submenu parent-megamenu megamenu">
											<div class="row">
												<div class="submenu-banner submenu-banner-menu-1">
						...
						<div class="col-sm-12 ">
							...
							<form:form action="/index/register" modelAttribute="register" method="post">
								<p class="form-row form-row-wide">
									...
									<form:input type="text" path="fullname" name="fullname" placeholder="Full Name" class="input-text"/>
									<form:errors path="fullname" cssClass="error"></form:errors>
								</p>
								<p class="form-row form-row-wide">
									<label>User name<span class="required">*</span></label> 
									<form:input type="text" name="username" path="username" placeholder="User Name" class="input-text"/>
									<form:errors path="username" cssClass="error"></form:errors>
								</p>
								<p class="form-row form-row-wide">
									<label>Email Address<span class="required">*</span></label>
									<form:input type="email" name="email" path="email" placeholder="Email Address" class="input-text"/>
									<form:errors path="email" cssClass="error"></form:errors>
								</p>
								<p class="form-row form-row-wide">
									<label>Password:<span class="required">*</span></label> 
									<form:input id="pswrd" onclick="show()" type="password" name="password" path="password" class="input-text" placeholder="Password"/>
									<form:errors path="password" cssClass="error"></form:errors>
								</p>
								<p class="form-row form-row-wide">
									<label>Address<span class="required">*</span></label>
									<form:input type="address" name="address" path="address" placeholder="Your Address" class="input-text"/>
									<form:errors path="address" cssClass="error"></form:errors>
								</p>
								<a href="/index/login" class="forgot-password">You have an account?</a>
								...
								<button type="submit"  onmousedown="myFunction()" title="Subscribe" class="btn subscribe">
									<span>Sign In</span>
								</button>
							</form:form>
						</div>
						...
						<div class="col-md-4 col-sm-6 equal-elem">
							...
							<div class="contacts">
								...
								<span class="contacts-info info-address ">05 Street No. 8, Binh Hung Hoa A Ward, Binh Tan District, City. Ho Chi Minh</span> <span
									class="contacts-info info-phone">(+84) 963230016</span> <span
