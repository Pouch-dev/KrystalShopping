...
<!-- Mirrored from kute-themes.com/html/krystal/html/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:40 GMT -->
<head>
                ...
                <form action="checkout" class="checkout" method="post">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">   
                            ...
                            <input type="text" name="fullname" class="form-control" id="forFName" placeholder="Your name" >
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="numberphone" class="form-control" placeholder="10 digits format">
                        </div>
                        <div class="form-group col-md-6">
                        ...
                        <div class="form-group payment col-md-6">
                            ...
                            <ul>
                                ...
                                <li><label class="inline" ><input type="radio" name="radio"><span class="input"></span>Pay When Ordering</label></li>
                                <li><label class="inline" ><input type="radio" name="radio"><span class="input"></span>Payment Via Credit Card</label></li>
                            </ul>
                            <p class="credit">You can pay by credit card or pay on receipt</p>
