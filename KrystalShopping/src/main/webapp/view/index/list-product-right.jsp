...
<!-- Mirrored from kute-themes.com/html/krystal/html/list-product-right.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:36 GMT -->
<head>
...
<link
	href="../../../../fonts.googleapis.com/css2277.css?family=Open+Sans:300,400,600,600i,700,700i"
	rel="stylesheet">
<link
	href="../../../../fonts.googleapis.com/css1b12.css?family=Roboto:300,400,400i,500,500i,700"
	rel="stylesheet">
</head>
						...
						<div class="main-content">
							<div class="promotion-banner style-3">
								<a href="#" class="banner-img"><img
									src="/images/product/banner-product.jpg" alt="banner-product"></a>
							</div>
								...
								<div class="toolbar-option">
									<div class="toolbar-sort">
										<select class="chosen-select sorter-options form-control">
											<option selected="selected" value="position">Lọc
												Theo</option>
									...
									<div class="toolbar-per">
										<select class="chosen-select limiter-options form-control">
											<option selected="selected" value="6">Lọc Theo</option>
											<option value="15">Giảm Dần</option>
											<option value="30">Tăng Dần</option>
										</select>
									</div>
									<div class="modes">
										<a href="grid-product.html" class="modes-mode  mode-grid"
											title="Grid"><i class="flaticon-squares"></i> <span>Grid</span>
										</a> <a href="list-product.html" title="List"
											class="active modes-mode mode-list"><i
											class="flaticon-interface"></i> <span>List</span> </a>
									</div>
								</div>
							</div>
								...
								<c:forEach var="p" items="${list_product.content}">
									<div class="product-items">
										<div class="product-image">
											<a href="#"><img src="/images/All/${p.image}.jpg" alt="p1"></a>
										...
										<div class="product-info">
											...
											<span class="star-rating"> <i class="fa fa-star"
										...
										<div class="product-info-price">
											...
											<span class="price"> 
											<ins>$${(((100-p.sale)/100)*p.price)}</ins>
	                                        <del>$${p.price}</del>
											</span>
											<div class="single-add-to-cart">
												<a href="/shopping-cart/add/${p.id}" class="btn-add-to-cart">Add to cart</a> <a
													href="#" class="compare"><i
													class="flaticon-refresh-square-arrows"></i>Compare</a> <a
													href="#" class="wishlist"><i class="fa fa-heart-o"
							...
							<div class="pagination">
								<ul class="nav-links">
									<li><a href="list?show=0">First</a></li>
									<li><a href="list?show=${list_product.number-1}">Prev</a></li>
									<li><a href="list?show=${list_product.number+1}">Next</a></li>
									<li class="back-next"><a href="list?show=${list_product.totalPages-1}">Last</a></li>
								</ul>
								<span class="show-resuilt">Showing ${list_product.number+1} of ${list_product.totalPages} result</span>
							</div>
						</div>
					</div>
					<div class="col-md-3 col-sm-4">
						<div class="col-sidebar">
								...
								<div class="block-content">
									<div class="filter-options-item filter-categori">
										...
										<div class="filter-options-content">
											<ul>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Home
														Audio & Theater</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>TV &
														Video</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Camera,
														Photo & Video</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Cell
														Phones & Accessories</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Headphones</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Video
														Games</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Bluetooth
														& Wireless Speakers</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Gaming
														Console</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Computers
														& Tablets</label></li>
											</ul>
										</div>
									</div>
									<div class="filter-options-item filter-brand">
										...
										<div class="filter-options-content">
											<ul>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Cameras</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Smartphone</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Printer
														& Ink</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Game &
														Consoles</label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Sound &
														Speaker</label></li>
											</ul>
										</div>
									</div>
									<div class="filter-options-item filter-price">
										...
										<div class="filter-options-content">
											<div class="price_slider_wrapper">
												<div data-label-reasult="Price:" data-min="0"
													data-max="3000" data-unit="$" class="slider-range-price "
													data-value-min="85" data-value-max="2000">
									...
									<div class="filter-options-item filter-size">
										...
										<div class="filter-options-content">
											<ul>
												<li><label class="inline"><input
														type="checkbox"><span class="input">S</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input">M</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input">L</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input">XL</span></label></li>
											</ul>
										</div>
									</div>
									<div class="filter-options-item filter-color">
										...
										<div class="filter-options-content">
											<ul>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Red<span
														class="value">(217)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Black<span
														class="value">(79)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Grey<span
														class="value">(116)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>While<span
														class="value">(38)</span></label></li>
											</ul>
											<ul>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Yellow<span
														class="value">(179)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Blue<span
														class="value">(283)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Pink<span
														class="value">(29)</span></label></li>
												<li><label class="inline"><input
														type="checkbox"><span class="input"></span>Green<span
							...
							<div class="block-banner-sidebar">
								<a href="#"><img src="/images/product/banner-sidebar.jpg"
					...
					<div
						...
						<div class="product-item style1">
							<div class="product-inner equal-elem">
								<div class="product-thumb">
									...
									<span class="onsale">-50%</span> <a href="#" class="quick-view">Quick
										View</a>
								</div>
								<div class="product-innfo">
									<div class="product-name">
									...
									<div class="group-btn-hover style2">
										<a href="#" class="add-to-cart"><i
											class="fa fa-shopping-bag" aria-hidden="true"></i></a> <a
											href="#" class="compare"><i
											class="flaticon-refresh-square-arrows"></i></a> <a href="#"
						...
						<div class="product-item style1">
							<div class="product-inner equal-elem">
								<div class="product-thumb">
									...
									<span class="onnew">new</span> <a href="#" class="quick-view">Quick
										View</a>
								</div>
								<div class="product-innfo">
									<div class="product-name">
										<a href="#">Basketball Sports Shoes</a>
									</div>
									<span class="price price-dark"> <ins>$229.00</ins>
									</span> <span class="star-rating"> <i class="fa fa-star"
										aria-hidden="true"></i> <i class="fa fa-star"
						...
						<div class="product-item style1">
							<div class="product-inner equal-elem">
								...
								<div class="product-innfo">
									<div class="product-name">
										<a href="#">Dark Green Prada Sneakers</a>
									</div>
									<span class="price price-dark"> <ins>$229.00</ins>
									</span> <span class="star-rating"> <i class="fa fa-star"
										aria-hidden="true"></i> <i class="fa fa-star"
						...
						<div class="product-item style1">
							<div class="product-inner equal-elem">
								...
								<div class="product-innfo">
									<div class="product-name">
										<a href="#">Clutches in Men's Bags for Men</a>
									</div>
									<span class="price price-dark"> <ins>$229.00</ins>
									</span>
									<div class="group-btn-hover style2">
					...
					<div class="section-brand style1">
						<div class="owl-carousel nav-style3" data-nav="true"
							...
							<a href="#" class="item-brand"><img
								src="/images/home1/brand1.jpg" alt="brand1"></a> <a href="#"
								class="item-brand"><img src="/images/home1/brand1.jpg"
								alt="brand1"></a> <a href="#" class="item-brand"><img
								src="/images/home1/brand1.jpg" alt="brand1"></a> <a href="#"
								class="item-brand"><img src="/images/home1/brand1.jpg"
								alt="brand1"></a> <a href="#" class="item-brand"><img
								src="/images/home1/brand1.jpg" alt="brand1"></a> <a href="#"
						...
						<div class="col-md-4 col-sm-6 equal-elem">
							...
							<div class="contacts">
								<p class="contacts-info">Nullam tristique tortor nibh, in
									...
									auctor.</p>
								<span class="contacts-info info-address ">218 Fifth
									Avenue, HeavenTower NewYork City</span> <span
									class="contacts-info info-phone">(+68) 123 456 7890</span> <span
									class="contacts-info info-support">Hot-Support@Krystal.com</span>
								<div class="socials">
