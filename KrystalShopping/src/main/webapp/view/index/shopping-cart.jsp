...
<!-- Mirrored from kute-themes.com/html/krystal/html/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:39 GMT -->
<head>
					...
					<div class="col-md-9">
						<form class="form-cart">
										...
										<form action="/shopping-cart/update/${item.productID}" method="post">
												<tr>
													...
													<td class="tb-remove"><a
														href="/shopping-cart/remove/${item.productID}"
							...
							<div class="cart-actions">
								<span><a href="/index/home" class="btn-continue">Continue
										Shopping</a></span> <span><a href="/shopping-cart/clear"
									class="btn-update">Clear Shopping Cart</a></span>
							</div>
						</form>
					</div>
					<div class="col-md-3 padding-left-5">
						<div class="order-summary">
							...
							<div class="checkout-element-content">
								<span class="order-left">Subtotal:<span>${total}</span></span> <span
									class="order-left">Shipping:<span>Free Shipping</span></span> <span
									class="order-left">Total:<span>${total}</span></span>
								<ul>
									<li><label class="inline"><input type="checkbox"><span
											class="input"></span>I have promo code</label></li>
								</ul>
								<form action="/shopping-cart/checkout" method="get">
...
<!-- Mirrored from kute-themes.com/html/krystal/html/shopping-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:40 GMT -->
</html>