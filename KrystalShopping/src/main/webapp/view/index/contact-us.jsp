...
<!-- Mirrored from kute-themes.com/html/krystal/html/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:40 GMT -->
<head>
        ...
        <main class="site-main contact-us">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <form:form action="/index/send" method="post" enctype="multipart/form-data" modelAttribute="mailinfo">
                        ...
                        <div class="col-md-5">
                            <div class="contact-info">
                                ...
                                <p class="form-row form-row-wide">
                                    ...
                                    <form:input path="subject" type="text" value="" name="text" placeholder="Your name" class="input-text"/>
                                </p>
                                <p class="form-row form-row-wide">
                                    <label>Email<span class="required">*</span></label>
                                    <form:input type="email" path="to" value="" name="text" placeholder="Your Email" class="input-text"/>
                                </p>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <p class="form-row form-row-wide form-text">
                                ...
                                <form:textarea path="body" aria-invalid="false" class="textarea-control" rows="5" cols="40" name="message"/>
                            </p>
                            <p class="form-row">
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-6 equal-elem">
                                ...
                                <div class="contacts">
                                    ...
                                    <span class="contacts-info info-address ">05 Street No. 8, Binh Hung Hoa A Ward, Binh Tan District, City. Ho Chi Minh</span>
                                    <span class="contacts-info info-phone">(+84) 96-323-0016</span>
                                    <span class="contacts-info info-support">diemphuoc5555@gmail.com</span>
                                    <div class="socials">
...
<!-- Mirrored from kute-themes.com/html/krystal/html/contact-us.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 May 2021 05:17:41 GMT -->
</html>