...
<head>
  ...
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="/img_admin/apple-icon.png" />
  ...
  <link href="/css_admin/material-dashboard98f3.css?v=1.3.0" rel="stylesheet"/>
  ...
  <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css_admin?family=Roboto:300,400,500,700|Material+Icons" />
...
<div class="wrapper wrapper-full-page">
  <div class="full-page lock-page" filter-color="black" data-image="/img_admin/lock.jpg">

    <!--   you can change the color of the filter page using: data-color="blue | green | orange | red | purple" -->

    <div class="content">
      <form action="/index/admin" method="post" enctype="multipart/form-data">
        <div class="card card-profile card-hidden">
          <div class="card-avatar">
            <a href="#pablo">
              <img class="avatar" src="/img_admin/faces/avatar.jpg" alt="...">
            </a>
          </div>
    ...
    <ul class="dropdown-menu">
      ...
      <li class="active">
        <a class="img-holder switch-trigger" href="javascript:void(0)">
          <img src="/img_admin/sidebar-1.jpg" data-src="/img_admin/login.jpeg" alt="" />
        </a>
      </li>
      <li>
        <a class="img-holder switch-trigger" href="javascript:void(0)">
          <img src="/img_admin/sidebar-2.jpg" data-src="/img_admin/lock.jpeg" alt="" />
        </a>
      </li>
      <li>
        <a class="img-holder switch-trigger" href="javascript:void(0)">
          <img src="/img_admin/sidebar-3.jpg" data-src="/img_admin/header-doc.jpeg" alt="" />
        </a>
      </li>
      <li>
        <a class="img-holder switch-trigger" href="javascript:void(0)">
          <img src="/img_admin/sidebar-4.jpg" data-src="/img_admin/bg-pricing.jpeg" alt="" />
        </a>
      </li>
    </ul>
  </div>
...
<script src="/js_admin/perfect-scrollbar.jquery.min.js" type="text/javascript"></script>

<!-- Include a polyfill for ES6 Promises (optional) for IE11, UC Browser and Android browser support SweetAlert -->
<script src="/js_admin/core.js"></script>
...
<!--  Google Maps Plugin    -->
<script type="text/javascript" src="https://maps.googleapis.com/maps/api/js_admin?key=AIzaSyD1_8C5Xz9RpEeJSaJ3E_DeBv8i7j_p6Aw"></script>
